...
def main():
    ...
    # input_name = 'bike'
    input_name = 'bike_w_hqsam'
    image_path = f'./examples/images/{input_name}'
    # ordering is important
    images = sorted(os.listdir(image_path))

    # output dir
    os.makedirs(f'./examples/outputs/{input_name}', exist_ok=True)
    ...
    mask = Image.open(f'./examples/masks/{input_name}/00000.png')
    ...
    for ti, image_name in enumerate(images):
        ...
        # save the mask
        mask.save(f'./examples/outputs/{input_name}/{ti}.png')
